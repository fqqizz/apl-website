      ...
      <header className="fixed left-0 right-0 top-0 z-50 px-4 pt-4 md:px-6 md:pt-5">
        ...
        >
          <Link href="/" className="shrink-0 pl-0.5 relative group" aria-label="Apex Premier League home">
            ...
            <img src="/apl-logo.png" alt="APL" width={40} height={40} className="h-8 w-auto md:h-9 relative z-10" />
          </Link>
        ...
        {menuOpen && (
          ...
          >
            <div className="flex items-center justify-between px-5 pt-6">
              <img src="/apl-logo.png" alt="APL" width={40} height={40} className="h-8 w-auto" />
              <button
                type="button"
