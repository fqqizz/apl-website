...
import { LayoutDashboard, Users, Building2, CreditCard, LogOut, Menu, X, Mail, BarChart3, Megaphone } from "lucide-react";
        ...
        <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-4 md:px-6">
          <div className="flex items-center gap-3">
            ...
            <Link href="/admin" className="flex items-center gap-2">
              <img src="/apl-logo.png" alt="APL" width={32} height={32} className="h-8 w-auto" />
