...
export const metadata: Metadata = createMetadata({
  title: "Franchise Ecosystem | Apex Premier League",
  description: "Own an APL franchise. Limited founding spots for Season One investors and football entrepreneurs.",
  path: "/franchises"
});
